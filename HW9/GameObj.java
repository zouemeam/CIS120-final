...
public abstract class GameObj {
    ...
    public int max_x;
    public int max_y;
    // keeps a public field for object's appearance, used for drawing the object
    public Appearance look;
    // keeps a public field for object's type, used to determine which version
    // of trytofire method
    // to run
    public String type;
     ...
     * Constructor
     */
    public GameObj(String appearRef, int v_x, int v_y, int pos_x, int pos_y, int width, int height,
            int court_width, int court_height) {
        this.look = AppearanceResource.get().getAppearance(appearRef);
        this.v_x = v_x;
        this.v_y = v_y;
        this.pos_x = pos_x;
        this.pos_y = pos_y;
     ...
     *            frame, etc.)
     */
    // Draw the object using the draw mathod of its appearance
    public void draw(Graphics g) {

        look.display(g, pos_x, pos_y);

    }

    // All game objects need to implement the abstract method collidedWith
    public abstract void collidedWith(GameObj other);

    // All objects have the trivial trytofire method, but only Boss and Player
    // class have actual
    // implementation of this method.
    public void trytofire() {
    }

    // Method to change the look of the object after purchases in the shop
    public void setLook(String type) {
        this.look = AppearanceResource.get().getAppearance(type);
    }
}
